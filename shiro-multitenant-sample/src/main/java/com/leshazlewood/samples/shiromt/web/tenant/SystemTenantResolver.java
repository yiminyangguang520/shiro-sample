...
/**
 * {@link TenantResolver} that will ignore the request/response pair and always resolve to the installation's single (system) tenant.  Typically used for single-tenant
 * installations and in testing.  Production-quality implementations will probably resolve a tenant based on subdomain or other request-specific properties.
 *

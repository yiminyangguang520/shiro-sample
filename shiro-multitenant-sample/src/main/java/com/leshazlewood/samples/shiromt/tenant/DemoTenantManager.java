...
/**
 * Demo TenantManager implementation.  Does not use a data source for simplicity.  In reality, this would invoke a TenantDAO that uses Hibernate or JPA to interact with a
 * database or NoSQL data store.
 * @author min
 */

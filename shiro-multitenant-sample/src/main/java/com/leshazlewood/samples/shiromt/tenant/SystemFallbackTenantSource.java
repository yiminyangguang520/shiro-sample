...
/**
 * {@link MutableTenantSource} implementation that uses a delegate instance but will return the default system tenant in case the delegate does not reference a tenant.
 *

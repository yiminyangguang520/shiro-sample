...
/**
 * Wrapper {@link MutableTenantSource} implementation that guarantees that a call to the internal delegate {@link TenantSource#getTenant() getTenant()} call always
 * returns a non-null value.  If a non-null value is discovered, an {@link IllegalStateException} is thrown.
 *
 * @author min
 * @since 0.1
 */
